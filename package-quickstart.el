...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/zenburn-theme-20240926.619/zenburn-theme-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/vertico-20250901.1440/vertico-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/goto-chg-20240407.1110/goto-chg-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/evil-20250812.1023/evil-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/dash-20250312.1307/dash-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/s-20220902.1511/s-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/avy-20241101.1357/avy-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/ace-window-20220911.358/ace-window-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/pfuture-20220913.1401/pfuture-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/lv-20200507.1518/lv-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/hydra-20250316.1254/hydra-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/ht-20230703.558/ht-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/posframe-20250211.110/posframe-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/cfrs-20250729.1422/cfrs-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/treemacs-20250729.1429/treemacs-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/treemacs-evil-20250320.2145/treemacs-evil-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/svg-lib-0.3/svg-lib-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/f-20241003.1131/f-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/shrink-path-20190208.1335/shrink-path-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/orderless-20250728.243/orderless-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/nerd-icons-20250829.1411/nerd-icons-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/nerd-icons-completion-20250811.751/nerd-icons-completion-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/modus-themes-20250718.410/modus-themes-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/marginalia-20250824.834/marginalia-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/kind-icon-0.2.2/kind-icon-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/gptel-20250901.245/gptel-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/fcitx-20240121.1829/fcitx-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/exec-path-from-shell-20240411.859/exec-path-from-shell-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/evil-escape-20241212.1318/evil-escape-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/doom-modeline-20250729.216/doom-modeline-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/dashboard-20250708.57/dashboard-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/corfu-20250831.1503/corfu-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/kwn/.emacs.d/elpa/cape-20250807.2138/cape-autoloads.el")(load-true-file-name load-file-name))
...
(setq package-activated-list
	  (delete-dups
	   (append
		'(zenburn-theme vertico goto-chg evil dash s avy ace-window
						pfuture lv hydra ht posframe cfrs treemacs
						treemacs-evil svg-lib f shrink-path orderless
						nerd-icons nerd-icons-completion modus-themes
						marginalia kind-icon gptel fcitx
						exec-path-from-shell evil-escape doom-modeline
						dashboard corfu cape)
		package-activated-list)))
(progn
  (require 'info) (info-initialize)
  (setq Info-directory-list
		(append
		 '("/home/kwn/.emacs.d/elpa/modus-themes-20250718.410"
		   "/home/kwn/.emacs.d/elpa/orderless-20250728.243"
		   "/home/kwn/.emacs.d/elpa/dash-20250312.1307"
		   "/home/kwn/.emacs.d/elpa/evil-20250812.1023")
		 Info-directory-list)))

;; Local Variables:
